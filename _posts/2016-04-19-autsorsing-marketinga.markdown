...
<h2 class="block__space--top-h2 h1 bold max-width-text">1) Решите для себя, какой маркетолог вам нужен: «голова» или «руки»</h2>
...
<section class="row-gap--m">
<h2 class="block__space--top-h2 h1 bold max-width-text">2) Не&nbsp;начинайте работу, пока не&nbsp;удостоверитесь в&nbsp;точном понимании партнером задачи и&nbsp;требований к&nbsp;выполнению</h2>
...
<section class="row-gap--m ">
<h2 class="block__space--top-h2 h1 bold max-width-text">3) Разбивайте задание на&nbsp;этапы и&nbsp;установите точки контроля</h2>
