...
description: "Изучите различные методы и&nbsp;инструменты для оптимизации изображений на&nbsp;вашем сайте. Узнайте о&nbsp;важности адаптации изображений под разные устройства и&nbsp;как Cloudinary может упростить этот процесс."
date:   2018-10-02
...
<ul class="additive-spacing">
	...
	<li class="list-li">
		<p>Появился <a class="link" href="https://developers.google.com/speed/webp/" >новый формат изображений&nbsp;— WebP</a>, который делает вес фото еще меньше. Пока формат поддерживается не&nbsp;всеми браузерами → для браузеров, которые «видят» WebP, следует предлагать WebP, а&nbsp;остальным&nbsp;— другие форматы. </p>
	</li>
	<li class="list-li">
...
<h2 class="section__title h1 bold ">Новое требование: каждому экрану свое изображение </h2>
...
<h2 class="section__title h1 bold ">А&nbsp;можно&nbsp;ли проще? </h2>
