...
<p> Узнать больше: </p>
				<ul>
					<li class="list-li">
						<a class="link" href="/blog/otkaz-ot-brifov/">Почему я не прошу заполнять брифы</a>
					</li>
					<li class="list-li">
						<a class="link" href="/blog/kak-agentstva-skryvayut-slabye-resheniya/">Выбор концепции рекламной кампании: почему одна идея лучше трех</a>
					</li>
