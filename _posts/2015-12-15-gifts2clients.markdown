...
<h2 class="block__space--top-h2 h1 bold ">Стоит&nbsp;ли делать корпоративные подарки на&nbsp;Новый год</h2>
...
<section class="row-gap--m max-width-text">
<h2 class="block__space--top-h2 h1 bold ">Что на&nbsp;Новый год подарить клиенту </h2>
