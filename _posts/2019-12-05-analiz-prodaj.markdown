---
layout: post
title:  "Алгоритм анализа продаж: проверенный метод исследователей рынка"
name: "Алгоритм анализа продаж"
description: "Делюсь алгоритмом анализа продаж, разработанный на&nbsp;основе опыта работы в&nbsp;Нильсене. Идеально подходит для FMCG, но&nbsp;логику анализа можно использовать и&nbsp;в&nbsp;других отраслях."
date:   2019-12-05
