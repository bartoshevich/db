---
layout: post
title:  "Customer Journey Map: как понять клиента и улучшить маркетинг"
name: "Как создать Customer Journey Map (CJM) и&nbsp;превратить клиентов в&nbsp;лояльных покупателей"
description: "Почему клиенты уходят? Карта потребительского опыта (CJM) покажет слабые места бизнеса. Готовый алгоритм и&nbsp;лучшие инструменты для маркетологов."
date:   2016-06-06
...
<li class="list-li">
  <a href="/blog/iskusstvennyj-intellekt-v-marketinge/" class="link"> Заменит ли ИИ маркетолога?</a>
</li>
</ul>