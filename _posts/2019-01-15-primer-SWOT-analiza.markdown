...
<p>SWOT-анализ – один из&nbsp;ключевых инструментов стратегического планирования, который часто неправильно понимается. Рассмотрю типичные ошибки, возникающие при проведении SWOT-анализа, и&nbsp;способы их&nbsp;избежать. </p>
