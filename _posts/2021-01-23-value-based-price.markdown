---
layout: post
title:  "Почасовая оплата должна умереть | Дмитрий Бартошевич"
...
<h2 class="block__space--top-h2 mb-m h1 bold">Что не&nbsp;так с&nbsp;оплатой за&nbsp;час? </h2>


<section class="row-gap--m" id="1.1">
<h3 class="mt-m mb-m h2 bold">Пережиток индустриальной эпохи</h3>
...
<h2 class="block__space--top-h2 mb-m h1 bold">Альтернатива почасовой оплате </h2>
...
<h2 class="block__space--top-h2 mb-m h1 bold">Как назначать цены на&nbsp;основе ценности </h2>
