---
layout: post
title:  "Качество проведения маркетингового исследования: способы контроля | Дмитрий Бартошевич"
...
<p>Вместе с&nbsp;результатами опроса запросите у&nbsp;агентства информацию об&nbsp;ip-адресе каждого респондента. Убедитесь, что нет повторов. Если в&nbsp;качестве респондентов вы&nbsp;хотели видеть жителей определенного региона, проверьте географическое расположение ip-адреса (например, <a class="link" href="http://xseo.in/ipinfo" >с&nbsp;помощью сервиса xseo.in/ipinfo</a>).</p>
