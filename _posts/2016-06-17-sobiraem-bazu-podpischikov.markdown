---
layout: post
title: "Собрал базу подписчиков | Дмитрий Бартошевич"
...
<p>Для компании 3Dom&nbsp;— производителя корпусной мебели&nbsp;— <a class="link" href="/blog/3dom-mebel-dlya-semi/" title="рассказываю, как разрабатывал концепцию бренда 3Dom">я&nbsp;создал концепцию бренда</a>, разработал и&nbsp;координировал проведение рекламный кампаний. Одной из&nbsp;моих инициатив была и&nbsp;<b>email-рассылка</b>. Идея клиенту нравилась, но&nbsp;на&nbsp;тот момент у&nbsp;компании не&nbsp;было базы адресов потенциальных клиентов. В&nbsp;статье расскажу, <strong>как с&nbsp;нуля собирали базу подписчиков</strong>.</p>

<section class="row-gap--m">
<h2 class="block__space--top-h2 h1 bold ">Замысел</h2>
...
<section class="row-gap--m">
<h2 class="block__space--top-h2 h1 bold ">Как реализовывали</h2>
...
<section class="row-gap--m">
<h2 class="block__space--top-h2 h1 bold ">Что получили</h2>
...
<section class="row-gap--m">
<h2 class="block__space--top-h2 h1 bold ">Штрихи к&nbsp;описанию акции</h2>
