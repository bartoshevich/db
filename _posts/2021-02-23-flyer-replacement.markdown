...
<div class="full-bleed"  itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
  ...
  <div class="figcaption">«Помощник в выборе ворот». <button class="link button" onclick="window.open('https://res.cloudinary.com/bartoshevich/image/upload/v1614108947/site/draft-helper.jpg', '_blank')" aria-label="Открыть в новой вкладке">Открыть  в&nbsp;новой вкладке</button>
  </div>
</div>
...
<div class="full-bleed"  itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
  ...
  <div class="figcaption" itemprop="description">Внутренний разворот «помощника». <button class="link button" onclick="window.open('https://res.cloudinary.com/bartoshevich/image/upload/v1614110806/site/helper-1.jpg', '_blank')" aria-label="Открыть в новой вкладке">Открыть в&nbsp;новой вкладке</button></div>
</div>
...
<div class="full-bleed"  itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
  ...
  <div class="figcaption">Варианты исполнения. <button class="link button" onclick="window.open('https://res.cloudinary.com/bartoshevich/image/upload/v1614110807/site/helper-2.jpg', '_blank')" aria-label="Открыть изображение в новой вкладке">Открыть в&nbsp;новой вкладке</button> </div>
</div>
...
<div class="full-bleed"  itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
  ...
  <div class="figcaption"><button class="link button" onclick="window.open('https://res.cloudinary.com/bartoshevich/image/upload/v1614110807/site/helper-3.jpg', '_blank')" aria-label="Открыть изображение в новой вкладке">Открыть в&nbsp;новой вкладке</button></div>
</div>
