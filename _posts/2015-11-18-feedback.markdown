---
layout: post
title: "Руководство по методике NPS: как повысить лояльность клиентов | Дмитрий Бартошевич"
name: "Всё, что нужно знать о&nbsp;методике NPS для повышения лояльности клиентов"
description: "Net Promoter Score - подробное руководство: как шаг за&nbsp;шагом применить методику NPS для повышения лояльности клиентов. Узнайте об&nbsp;основных ошибках и&nbsp;примерах из&nbsp;практики. "
date:   2015-11-18
...
<p>Привлекательность методики NPS заключается в&nbsp;ее&nbsp;простоте. Достаточно задать всего два вопроса, и&nbsp;вы&nbsp;получите информацию, которая напрямую связана с&nbsp;тем, как клиенты взаимодействуют с&nbsp;продуктами или услугами вашей компании. Исчезает необходимость в&nbsp;многостраничных опросниках и&nbsp;отзывах, которые никак не&nbsp;проясняют намерения покупателей. </p>
