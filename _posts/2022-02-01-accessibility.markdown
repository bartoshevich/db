---
layout: post
title:  "Доступность сайтов и&nbsp;приложений&nbsp;— новая норма | Дмитрий Бартошевич"
name: "Доступность сайтов&nbsp;— новая норма"
description: 'Доступность&nbsp;&mdash; это практика, позволяющая использовать ваши сайты как можно большему числу людей. '
date:   2022-02-01
...
<h3 id="semantics">Используйте семантические HTML теги</h3>
...
<h3 id="constancy">Придерживайтесь единообразия в&nbsp;структуре</h3>
...
<h3 id="links">Делайте очевидной цель ссылки </h3>
...
<h3 id="alt">Размещайте текстовые версии для нетекстового контента</h3>
...
<h3 id="contrast">Обеспечьте достаточный цветовой контраст </h3>
...
<p>Инструменты, с&nbsp;помощью которых можно выявить проблемные зоны:</p>
...
<h3 id="notonlycolor">Не&nbsp;полагайтесь только на&nbsp;цвет </h3>
