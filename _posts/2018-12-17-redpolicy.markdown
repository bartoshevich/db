...
<ul class="additive-spacing">
<li class="list-li">Организация обучающих воркшопов
...
<li class="list-li">Создание чек-листов и&nbsp;шаблонов
...
<li class="list-li">Внесение периодических корректировок
...
<li class="list-li">Мотивация и&nbsp;поощрение сотрудников
