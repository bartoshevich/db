---
layout: post
title:  "Создаю концепцию бренда для компании «PES Global» (Казахстан) | Дмитрий Бартошевич"
name: "Создаю концепцию бренда для компании «PES Global»"
description: 'Разработка концепции бренда PES Global: погружение в&nbsp;горнодобывающую отрасль Казахстана, понимание потребностей клиентов и&nbsp;выявление позиционирования в&nbsp;сфере поставок.'
date:   2023-08-13
...
<ul class="additive-spacing max-width-text"> 
	...
	<li class="list-li"> 
		Минималист: восприятие сотруднечества с компанией как индикатор качества его собственной работы. Также он&nbsp;оценит, что компания возьмет на&nbsp;себя часть его обязанностей (о&nbsp;том, как работает <span class="noperenos">PES Global</span>&nbsp;&mdash; чуть ниже).
 	</li>
	<li class="list-li"> 
