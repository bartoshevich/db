...
<p class="post__note">Что может помочь? <br>Помогут платформы, на которых общаются мигранты. Показательный пример&nbsp;— <a class="link" href="https://github.com/ru-de/faq">база знаний по&nbsp;миграции и&nbsp;жизни в&nbsp;Германии</a>. Читать и&nbsp;«переваривать» информацию&nbsp;(как по&nbsp;работе, так и&nbsp;по&nbsp;внерабочим вопросам) придется много.</p>
