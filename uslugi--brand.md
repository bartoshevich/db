...
description: "Создам концепцию бренда, которая выведет вашу торговую марку на новый уровень. Выделяйтесь среди конкурентов и привлекайте клиентов с помощью сильного бренда!"
...
<ol class="list-ol row-gap--l">
	<li class=" max-width-text additive-spacing">
		<h3 class="bold h2">Обсуждение задачи и целей</h3>
	...
	<li class="additive-spacing max-width-text">
			<h3 class="bold h2">Анализ бизнеса</h3>
	...
	<li class="additive-spacing">
			<h3 class="bold h2">Анализ конкурентов и клиентов</h3>
...
<li class="additive-spacing">
<h3 class="bold h2">Создание структуры бренда</h3>
...
<li class="additive-spacing">
<h3 class="bold h2">Представление результатов </h3>
...
<h3 class="bold h2">Внедрение концепции</h3>
