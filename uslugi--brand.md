...
description: "Концепция бренда&nbsp;&mdash; фундамент достижения стратегического преимущества в&nbsp;бизнесе. Отсутствие же концепции быстро превращает маркетинг в&nbsp;«крысиные бега»."
...
<section class="additive-spacing example--card max-width-text ">
		<div>
		<h2 class="bold">самопрезентация компании без концепции бренда</h2>
		<p>подобные компании встречал каждый </p>
		</div>
		<div class="row">
		<div class="c-5">
		<p class="italic">Описание</p>
		<ul>
...
<section class="full-bleed full-bleed-row additive-spacing ">
    ...
    <section class="grid-columns__first-one-half additive-spacing">
        <h3 class="bold h2">Последствия отсутствия концепции</h3>
    ...
    <section class="grid-columns__last-one-half additive-spacing">
     <h3 class="bold h2">Что меняет концепция</h3>
        <ul class="additive-spacing max-width-text">
...
<ol class="list-ol row-gap--l">
	...
	<li class="additive-spacing max-width-text">
			<h3 class="bold h2">Обсуждаю контекст задачи</h3>
