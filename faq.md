        ...
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text" class="with-side row-gap--m">
                <ul class="additive-spacing max-width-text">
                    <li class="list-li"><span class="bold">Подход к&nbsp;работе. </span>Представим, что логотип, фирменный стиль, концепции рекламных кампаний, сайт и&nbsp;пр. —&nbsp;кубики конструктора. Если кубики сочетать произвольным образом, результат случаен и&nbsp;непредсказуем. Однако, если имеется инструкция, можно создать нечто стоящее. Именно такую инструкцию я&nbsp;и&nbsp;разрабатываю&nbsp;&mdash; создаю концепцию бренда и&nbsp;на&nbsp;ее&nbsp;основе развиваю целостный, системный маркетинг в&nbsp;компании, определяю, что, когда и&nbsp;как нужно делать и&nbsp;каким критериям должен соответствовать результат.</li>

                    

                    <li class="list-li"> <span class="bold">Формат работы. </span>Для агентства вы&nbsp;— одна из&nbsp;20&nbsp;или 100&nbsp;компаний. Вы&nbsp;— в&nbsp;потоке, на&nbsp;конвейере. Вам предложат стандартизированные, выгодные для агентства варианты работы. Но&nbsp;не&nbsp;всегда
            ...
            <div itemprop="text">
                <ul class="additive-spacing max-width-text">
                    ...
                    <li> <span class="bold">Стоимость.</span> Компания оплачивает только стоимость проекта. Нет расходов на&nbsp;обустройство рабочего места, обучение, больничные, отпуска. Не&nbsp;нужно делать отчисления в&nbsp;ФСЗН и&nbsp;платить подоходный налог.
                           ...
                           {% endcomment %}
                    <li class="list-li"> <span class="bold">Трудовые взаимоотношения. </span>Регулировать сотрудничество с&nbsp;ИП юридически проще. </li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
                <ul class="additive-spacing max-width-text">
                    ...
                    <li class="list-li">
                        В&nbsp;2019 году прошел преквалификацию в&nbsp;Европейском банке реконструкции и&nbsp;развития. 
                    </li>
                    <li class="list-li">
                    ...
                    <li class="list-li">
                        Веду <a class="link" href="/blog/">блог</a> → можно узнать мой подход к&nbsp;работе до&nbsp;начала сотрудничества.
                    </li>
                    <li class="list-li">
                        Есть <a class="link" href="/cases/">успешные кейсы</a> и&nbsp;— как следствие&nbsp;— компании, которые меня рекомендуют.
                    </li>
                </ul>
            </div>
        </div>
