...
permalink: /
description: "Развиваю бренды, опираясь на&nbsp;маркетинговый аудит, исследования и&nbsp;анализ данных. Разрабатываю стратегии и&nbsp;контролирую их&nbsp;реализацию для достижения ваших бизнес-целей. Консультации по&nbsp;маркетингу."
keywords: "развитие брендов, анализ данных, разработка стратегий, контроль реализации, достижение бизнес-целей, консультант по маркетингу"
---
...
<h3><img class="icon--check" src="/assets/images/check.svg" alt=""><a class="link"  itemprop="url" href="/uslugi/marketing-audit/"><span itemprop="name">Аудит маркетинга</span></a></h3>
...
<section itemprop="serviceType">
<h3><img class="icon--check" src="/assets/images/check.svg" alt=""><a class="link" itemprop="url" href="/uslugi/brand-conception/"><span itemprop="name">Концепция бренда</span></a></h3>
<p>Создаю ясную, запоминающуюся идентичность бренда, которая отражает его суть и&nbsp;отличает от&nbsp;конкурентов. Ваш бренд станет нечто большим, чем продукт или услуга&nbsp;&mdash; он&nbsp;станет частью жизни вашей аудитории.</p>
</section>

<section itemprop="serviceType">
<h3><img class="icon--check" src="/assets/images/check.svg" alt=""><a class="link"  itemprop="url" href="/uslugi/razrabotka-reklamnyh-kampanij/"><span itemprop="name">Рекламные кампании</span></a></h3>
...
<section itemprop="serviceType">
<h3><img class="icon--check" src="/assets/images/check.svg" alt=""><a class="link" itemprop="url" href="/uslugi/autsorsing-marketinga/"><span itemprop="name">Абонентское обслуживание</span></a></h3>
...
<ul class=" list-reset clients__list max-width-text">
               <li>MODISTA </li>
    ...
    <p class="mt-m">Мой подход к&nbsp;каждому проекту&nbsp;&mdash; тщательный маркетинговый анализ и&nbsp;стратегическое планирование, направленные на&nbsp;укрепление позиций бренда на&nbsp;конкурентном рынке, выделение его уникальных качеств и&nbsp;развитие устойчивых отношений компании с&nbsp;целевой аудиторией.</p> 

<p class="mt-m">На&nbsp;странице «проекты» вы&nbsp;можете <a class="link" href="/cases/">познакомиться с&nbsp;кейсами</a>.</p>
</div>
</section>
...
<div class=" block__content">
    	...
    	<p class="citation">«Мы&nbsp;спрашивали себя: „Чем мы&nbsp;отличаемся? В&nbsp;чем сильнее? В&nbsp;чем отстаем и&nbsp;чего не&nbsp;хватает, чтобы быть лучшими?“ Ответы искали сами. Но&nbsp;того решения, которое устроило&nbsp;бы всех, не&nbsp;находили. Обратились за&nbsp;консультацией к&nbsp;Бартошевичу Дмитрию...»</p>
    		...
    		<cite>
    			<span itemprop="author">Дмитрий Лихтарович</span>, директор интернет-агентства Giperlink
    		</cite>
       ...
       <blockquote class="blockquote--emphasis" itemprop="reviewBody">
    		...
    		<div class="citation__author" >
    		<cite>
    			<span itemprop="author">Елена Горбачева</span>, директор типографии <span class="noperenos">Flex-n-Roll</span>
    		</cite>
...
{% comment %}
		...
		<img class="image" loading="lazy" decoding="async" 
			sizes="100vw" 
			srcset="https://res.cloudinary.com/bartoshevich/image/upload/w_640/f_auto,q_auto/v1700419281/site/blog_marketing.png 640w,
