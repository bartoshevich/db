---
layout: home
title: "Эксперт по маркетингу и развитию брендов: Дмитрий Бартошевич"
permalink: /
description: "Помогаю кампаниям расти через создание и развитие брендов. Аудит маркетинга, разработка концепций бренда и рекламные активности для малого и среднего бизнеса."
...
<article itemprop="serviceType">
<h3><img class="icon--check" src="/assets/images/check.svg" alt="" role="presentation"><a class="link"  itemprop="url" href="/uslugi/marketing-audit/"><span itemprop="name">Аудит маркетинга</span></a></h3>
