...
description: "Политика конфиденциальности: я&nbsp;не&nbsp;отслеживаю посетителей, не&nbsp;показываю рекламу и&nbsp;не&nbsp;собираю лишние данные. Рассказываю, как я&nbsp;обрабатываю персональную информацию и&nbsp;защищаю ваше право на&nbsp;приватность."
...
<p> 8.&nbsp;Для рассылок, электронных сообщений пользователям я&nbsp;использую программное обеспечение третьих лиц, которые могут собирать сведения о&nbsp;пользователях. Состав и&nbsp;условия сбора определяются их&nbsp;правообладателями и&nbsp;могут включать: </p>
<ul>
	<li class="list-li"> тип, версия, настройки браузера;</li>
	<li class="list-li"> настройки устройства и&nbsp;место его положения;</li>
	<li class="list-li"> версия операционной системы;</li>
	<li class="list-li"> время запроса, источник перехода, IP-адрес.</li>
</ul>
