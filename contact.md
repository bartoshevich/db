...
<figure class="block-230">
	...
	<figcaption>
		чтобы быстро добавить меня в&nbsp;книгу контактов, отсканируйте телефоном QR-код или <a class="link" href="/assets/images/contact/contact.csv" download>импортируйте csv-файл</a> (279 байт)
	</figcaption>
</figure>
